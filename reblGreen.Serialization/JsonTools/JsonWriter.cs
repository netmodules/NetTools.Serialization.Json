...
namespace reblGreen.Serialization.JsonTools
{
    ...
    public class JsonWriter
    {
        ...
        public string ToJson(object item, StringSerializationFactory serializerFactory)
        {
        ...
        void AppendValue(StringBuilder stringBuilder, object item, StringSerializationFactory serializerFactory)
        {
            if (item == null)
            {
