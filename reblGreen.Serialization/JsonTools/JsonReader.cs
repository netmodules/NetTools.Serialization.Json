...
namespace reblGreen.Serialization.JsonTools
{
    ...
    {
        public T FromJson<T>(string json, StringSerializationFactory serializerFactory)
        {
        ...
        object ParseValue(Type type, string json, StringSerializationFactory serializerFactory, StringBuilder stringBuilder, Stack<List<string>> splitArrayPool)
        {
        ...
        object ParseAnonymousValue(string json, StringSerializationFactory serializerFactory, StringBuilder stringBuilder, Stack<List<string>> splitArrayPool)
        {
            if (json.Length == 0)
            {
                return null;
        ...
        object ParseObject(Type type, string json, StringSerializationFactory serializerFactory, StringBuilder stringBuilder, Stack<List<string>> splitArrayPool)
        {
            var obj = serializerFactory.FromString(json.RemoveDoubleQuotes(), type);
